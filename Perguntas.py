...
# Listas Auxiliares
LISTA_DIRECIONAMENTO = ["Eventos e Programas", "Portifólio de Soluções", "Trilha do Conhecimento", "Diagnóstico Completo", "Negociação de Nova Parceria", "Atendimento | Construção Personalizada" ]
LISTA_DOR_PRINCIPAL = [
